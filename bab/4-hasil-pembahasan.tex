...
Sub-bab ini melaporkan keluaran nyata \textit{pipeline} ketika diuji pada potongan 3.001 \textit{frame} video gerbang utama. Paparan disusun mengikuti aliran data: arsitektur beserta keluaran tiap tahap pada \textit{frame} awal, persistensi pelacakan dengan selektivitas filter berlapis, kemudian kinerja sisi \textit{edge} dan lapisan distribusi. Susunan berurutan ini memperlihatkan bagaimana piksel mentah berubah bertahap menjadi catatan peristiwa, sekaligus menjaga paralel dengan rancangan \textit{pipeline} pada Bab~\ref{chap:metodologi}.
