...
\begin{enumerate}
  ...
  \item Bagaimana mengintegrasikan YOLOv8 dan ByteTrack dalam satu \textit{pipeline} pemrosesan video lokal serta mendistribusikan keluarannya melalui Apache Kafka dan Apache Spark Structured Streaming menjadi \textit{event stream} pelanggaran helm yang tervalidasi secara spasial (\textit{Intersection over Area}) dan temporal (\textit{N-Frame})?
